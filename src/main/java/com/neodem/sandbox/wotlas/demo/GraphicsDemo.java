...
import com.neodem.graphics.dd.engine.wotlas.drawable.MultiRegionImage;
import com.neodem.graphics.dd.engine.wotlas.policy.LimitWindowPolicy;
 ...
 /* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
    ...
    */
      public GraphicsDemo() {
       ...
       //
          gDirector = new EnhancedGraphicsDirector( new LimitWindowPolicy(), imageLib );
